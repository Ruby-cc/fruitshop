...
<div class="width100 hidden_yh" style="height: 573px;background: url('${ctx}/resource/user/images/bj.jpg') no-repeat center">
    <div class="width1200 hidden_yh center_yh" style="margin-top: 75px">
        <div class="right_yh bj_fff" style="width:408px;height: 438px;">
            <form action="${ctx}/login/utoLogin" method="post" onsubmit="return check()">
                ...
                <div class="center_yh hidden_yh" style="width: 336px;">
                    ...
                    <button type="button" class="center_yh" style="width: 100%;height: 43px;font-size: 16px;background: #dd4545;outline: none;border: 0;color: #fff; cursor:pointer;margin-top: 20px;"
                            onclick="window.location.href='res'">注册</button>
                </div>
            </form>
        </div>
    </div>
